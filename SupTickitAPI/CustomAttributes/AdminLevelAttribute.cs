...
{
    public class AdminLevelAttribute : Attribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!userRoleAssignments.Any(
                assignment => assignment.RoleId == RoleEnum.Administrator && assignment.StartDate < DateTime.UtcNow && assignment.ExpiryDate > DateTime.UtcNow))
            {
