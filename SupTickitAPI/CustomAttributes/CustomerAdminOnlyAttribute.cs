...
{
    public class CustomerAdminOnlyAttribute : Attribute, IAuthorizationFilter
    {
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!userRoleAssignments.Any(
                assignment => assignment.RoleId == RoleEnum.CustomerAdministrator && assignment.StartDate < DateTime.UtcNow && assignment.ExpiryDate > DateTime.UtcNow))
            {
